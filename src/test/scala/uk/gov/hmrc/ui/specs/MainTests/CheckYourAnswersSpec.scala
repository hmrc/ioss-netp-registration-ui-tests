...
class CheckYourAnswersSpec extends BaseSpec {
  ...
  Feature("Changing answers via the check-your-answers page") {
    ...
    Scenario("Intermediary removes all trading names via remove-all-trading-names page") {
      ...
      And("the intermediary changes the answer to no on the have-trading-name page")
      registration.checkJourneyUrl("have-trading-name?waypoints=check-your-answers")
      registration.answerRadioButton("no")
    ...
    Scenario(
      ...
      registration.checkJourneyUrl("check-your-answers")
      registration.selectChangeOrRemoveLink("add-trading-name\\?waypoints\\=check-your-answers")
      registration.checkJourneyUrl("add-trading-name?waypoints=check-your-answers")
      registration.answerRadioButton("yes")
      registration.checkJourneyUrl("trading-name/3")
      registration.enterAnswer("another trading-name")
      registration.checkJourneyUrl("add-trading-name?waypoints=check-your-answers")
      registration.answerRadioButton("no")
